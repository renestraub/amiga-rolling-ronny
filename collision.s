		...
		XDEF	MyHandleCollision,MyCollOneBob
...
.BobLoop:	move.l	bob_NextBob(A1),a1
		...
		cmp.b	#RONNY_ID,bob_Id(A1)
		beq.s	.BobLoop

		;move.w	bob_UserFlags(A1),d4		* Flags des ZielBobs
		;btst	#BOBB_ENEMY,d4			* EnemyBob
		;bne.s	.BobLoop			* --> Keine Kollision
