...
.NoAddWindow:	cmp.l	#150,LevelX(A6)
		blt.s	.Wait
		bsr	CheckJoy
		bne.s	.Wait
...
.ScrollDown:	bsr	DelayBlank
		...
		rts
* No Continue
EndText1:	dc.b	SETCURSOR,10,8, "WHAT A PITTY THAT YOU DID NOT"
		dc.b	SETCURSOR,10,17,"COMPLETE YOUR MISSION RONNY! NOW"
		dc.b	SETCURSOR,10,26,"I HAVE TO SEND OUT POLICEMEN TO"
		dc.b	SETCURSOR,10,35,"FIND AND COLLECT THE LOST JEWEL-"
		dc.b	SETCURSOR,10,44,"CASES. THIS EMBARASSING AFFAIRE"
		dc.b	SETCURSOR,10,53,"WILL GET PUBLIC AND RUIN THE"
		dc.b	SETCURSOR,10,62,"REPUTATION OF SCOTLAND YARD."
		dc.b	SETCURSOR,10,71,"I THINK I'LL NEED A SICK-LEAVE"
		dc.b	SETCURSOR,10,80,"REAL SOON...",0

* Finale
EndText2:	dc.b	SETCURSOR,10,8, "YOU DID A GREAT JOB, RONNY! YOUR BRAVE"
		dc.b	SETCURSOR,10,17,"DEED WILL SAVE THE REPUTATION OF SCOT-"
		dc.b	SETCURSOR,10,26,"LAND YARD. HER MAJESTY THE QUEEN WILL"
		dc.b	SETCURSOR,10,35,"BE DELIGHTED TO HEAR OF YOUR SUCCESS"
		dc.b	SETCURSOR,10,44,"IN RESTORING THE LOST JEWEL-CASES."
		dc.b	SETCURSOR,10,53,"YOU'VE EARNED YOURSELF A FREE TICKET"
		dc.b	SETCURSOR,10,62,"TO SWITZERLAND WHERE YOU ARE GOING TO"
		dc.b	SETCURSOR,10,71,"SPEND AN EXITING WEEK IN A BEAUTIFUL"
		dc.b	SETCURSOR,10,80,"CHALET IN THE MOUNTAINS...",0
...
;		move.l	VBCounter(A6),d0
;		add.l	#50*5,d0			* 5 Sec

;.Wait:		cmp.l	VBCounter(a6),d0
;		ble.s	.Cont

;		bsr	CheckJoy
;		bne.s	.Wait				* Loop -->

;.Cont:		clr.b	CycleFlag(A6)			* Cycle Int OFF
...
CubeText:	dc.b	SETCURSOR,12,18,SETCOLOR,24
		dc.b	"Jewel-Cases :"
		dc.b	SETCURSOR,12,27
		dc.b	"ExtraMoney  :",0

CubeText2:	dc.b	SETCURSOR,20+104,18
		dc.b	SETCOLOR,12,"%ld"
		dc.b	SETCURSOR,20+104,27,"%ld",0
...
ChangeIt:	movem.l	d0-d7/a0-a6,-(sp)
		...
		move.l	d1,d0				* File
		move.l	SongPtr,a0
		SYSCALL	BufReadFile			* Load GameSongI
...
StarByte:	movem.l	d0-d7/a0-a6,-(sp)
		...
		move.l	sc_Bitmap+bm_Planes(a3),a0	* BitmStr
		move.l	a0,a2				* LoadAddress
		move.l	#FN_STARBYTE,d0			* File
		SYSCALL	ReadFile

		move.l	a3,a0				* Screen
		move.l	a2,a1
		add.l	#40*256*6,a1			* ColorMap
		bsr	LoadRGB				* Show Screen
